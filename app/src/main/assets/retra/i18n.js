(() => {
  ...
  const vi = {
    ...
    'Appearance':'Giao diện','Theme, dark mode, accents':'Chủ đề, chế độ tối, màu nhấn','Video':'Hình ảnh','Renderer, scaling, frame rate':'Bộ dựng hình, tỉ lệ và tốc độ khung hình','Audio':'Âm thanh','Sound & Haptics':'Âm thanh & rung','Volume, latency, synchronization':'Âm lượng, độ trễ và đồng bộ','Game audio, controller sound, vibration':'Âm thanh trò chơi, âm nút và rung','Layouts':'Bố cục','Controls, buttons, screen placement':'Điều khiển, nút và vị trí màn hình','Misc':'Khác','Saves, screenshots, vibration, library':'Bản lưu, ảnh chụp, rung và thư viện','Saves, gameplay, library tools':'Bản lưu, lối chơi và công cụ thư viện','Advanced':'Nâng cao','Core options, BIOS, debugging':'Tùy chọn lõi, BIOS và gỡ lỗi','Fonts':'Phông chữ','Choose the Retra interface font':'Chọn phông chữ giao diện Retra','Language':'Ngôn ngữ','Choose the Retra interface language':'Chọn ngôn ngữ giao diện Retra','Retra version, licenses, information':'Phiên bản Retra, giấy phép và thông tin',
  ...
  const id = {
    ...
    'Appearance':'Tampilan','Theme, dark mode, accents':'Tema, mode gelap, warna aksen','Video':'Video','Renderer, scaling, frame rate':'Renderer, penskalaan, laju bingkai','Audio':'Audio','Sound & Haptics':'Suara & Haptik','Volume, latency, synchronization':'Volume, latensi, sinkronisasi','Game audio, controller sound, vibration':'Audio game, suara kontrol, getaran','Layouts':'Tata letak','Controls, buttons, screen placement':'Kontrol, tombol, posisi layar','Misc':'Lain-lain','Saves, screenshots, vibration, library':'Simpanan, tangkapan layar, getaran, pustaka','Saves, gameplay, library tools':'Simpanan, gameplay, alat pustaka','Advanced':'Lanjutan','Core options, BIOS, debugging':'Opsi core, BIOS, debugging','Fonts':'Font','Choose the Retra interface font':'Pilih font antarmuka Retra','Language':'Bahasa','Choose the Retra interface language':'Pilih bahasa antarmuka Retra','Retra version, licenses, information':'Versi Retra, lisensi, dan informasi',
