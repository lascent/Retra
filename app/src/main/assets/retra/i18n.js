(() => {
  ...
  const vi = {
    ...
    'Appearance':'Giao diện','Theme, dark mode, accents':'Chủ đề, chế độ tối, màu nhấn','Video':'Hình ảnh','Renderer, scaling, frame rate':'Bộ dựng hình, tỉ lệ và tốc độ khung hình','Audio':'Âm thanh','Sound':'Âm thanh','Volume, latency, synchronization':'Âm lượng, độ trễ và đồng bộ','Game audio and controller sound':'Âm thanh trò chơi và âm nút điều khiển','Layouts':'Bố cục','Controls, buttons, screen placement':'Điều khiển, nút và vị trí màn hình','Misc':'Khác','Saves, screenshots, library':'Bản lưu, ảnh chụp và thư viện','Saves, gameplay, library tools':'Bản lưu, lối chơi và công cụ thư viện','Advanced':'Nâng cao','Core options, BIOS, debugging':'Tùy chọn lõi, BIOS và gỡ lỗi','Fonts':'Phông chữ','Choose the Retra interface font':'Chọn phông chữ giao diện Retra','Language':'Ngôn ngữ','Choose the Retra interface language':'Chọn ngôn ngữ giao diện Retra','Retra version, licenses, information':'Phiên bản Retra, giấy phép và thông tin',
  ...
  const id = {
    ...
    'Appearance':'Tampilan','Theme, dark mode, accents':'Tema, mode gelap, warna aksen','Video':'Video','Renderer, scaling, frame rate':'Renderer, penskalaan, laju bingkai','Audio':'Audio','Sound':'Suara','Volume, latency, synchronization':'Volume, latensi, sinkronisasi','Game audio and controller sound':'Audio game dan suara kontrol','Layouts':'Tata letak','Controls, buttons, screen placement':'Kontrol, tombol, posisi layar','Misc':'Lain-lain','Saves, screenshots, library':'Simpanan, tangkapan layar, pustaka','Saves, gameplay, library tools':'Simpanan, gameplay, alat pustaka','Advanced':'Lanjutan','Core options, BIOS, debugging':'Opsi core, BIOS, debugging','Fonts':'Font','Choose the Retra interface font':'Pilih font antarmuka Retra','Language':'Bahasa','Choose the Retra interface language':'Pilih bahasa antarmuka Retra','Retra version, licenses, information':'Versi Retra, lisensi, dan informasi',
